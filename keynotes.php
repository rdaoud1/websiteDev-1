...
if($_GET)
{
	$notes = trim($_GET['keynotes']);
	$file = "announcements/keynotes.txt";
	$handle = fopen($file, 'w+') or die("can't open file");
	if(fwrite($handle, $notes))
	{
		?>
...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<h1>Update Safety Talk</h1>
			<br>
			<form action="keynotes.php" method="">
				<div class="form-group">
					<textarea class="form-control" name="keynotes" rows="10" id="keynotes"><?php
						$fh = fopen('announcements/keynotes.txt','r');
						while(! feof($fh))
						{
							echo fgets($fh);
						}
			...
			<div class="how-to-use">
				<h6>How to use:</h6>
				<p>
					The text area is populated with what the current keynotes are.<br/>
					Remove or add to the text area, then hit 'Update'<br/>
					One keynote per line
				</p>
			</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>keynotes have been updated Successfully</p>
							</div>
